    ...
    for time_steps in range(1,2):
        for nerons in range(30,31,1):
            for iteration in range(1):
                ...
                #a = ['Weighted_Price']+['Weighted_D1']+['Weighted_D2']+['Volume_(BTC)']+['Volume_(Currency)']+['Dif(OC)'] + ['Dif(HL)'] + ['Dif(HO)'] + ['Dif(LO)']
                a = ['Weighted_Price'] + ['Rising or Falling'] + ['Weighted_D1'] + ['Weighted_D2'] + [
                    'Open'] + ['High'] + ['Low'] + ['Close'] + ['Volume_(BTC)'] + [
                        'Volume_(Currency)'] + ['Dif(OC)'] + ['Dif(HL)'] + ['Gap(CO)'] + ['Dif(HO)'] + ['Dif(LO)']
                b = a.copy()
                ...
                #         if a[j] == 'Weighted_D1':
                #         b.remove(a[features_d])
                #     print(features_d,b)

                corre = pd.DataFrame(reframed)
                pyplot.figure(figsize=(16, 9))
